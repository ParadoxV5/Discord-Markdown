...
![Underline Bold Italics](assets/markdown1.png)

It doesn’t show on the Desktop/Web preview (at this writing), but *formatting can span multiple lines*![^n]

![Formatting Gallery, using multiline text](assets/markdown2.png)
...
![Cannot format a link with a link](assets/link2.png)
...
![a pile of lines](assets/code0.png)
...
> ![Ruby Discord Rule 7 (syntax highlighting)](assets/code4.png)
...
![Two bullet lines and two numbered lines](assets/list1.png)
...
![List continuation](assets/list2.png)
...
> ```
> ![Indent mechanics, rendered](assets/list3.png)
...
![Bullet points after a numbered list start becomes numbered lines](assets/list4.png)[^d]
...
![single-line block quote](assets/quote1.png)
...
![multiline block quote](assets/quote3.png)
...
![multiline quote on new editor](assets/quote4.png)
...
![code block quote](assets/quote5.png)
![triple-`>` block code quote on new editor](assets/quote6.png)
...
![multi-`>` block code quote on new editor](assets/quote7.png)
...
* On Desktop/Web, you can bring out a flyout to tag non-text channels (Voice, Guide, etc.) with `#!channel`
  ...
  ![non-text channels flyout](assets/shebang.png)
...
(Explicit `@`pings are still highlighted and counted). See: https://github.com/discord/discord-api-docs/commit/b7d6467
  ...
  ![This is a @silent message.](assets/silent.png)
